...
run_command("minikube start --driver=docker -p pc2 --nodes 3")
run_command("minikube profile pc2")

# Aplicamos los archivos YAML para desplegar los microservicios
run_command("minikube kubectl apply -f product-page.yaml")
...
run_command("minikube kubectl apply -- -f reviews-v3.yaml")
